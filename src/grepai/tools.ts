...
export const GREPAI_TOOL_NAMES = [
	...
	"grepai_trace_graph",
	// Disabled until grepai exposes refs through the installed CLI.
	// "grepai_refs_readers",
	// "grepai_refs_writers",
	// "grepai_refs_graph",
	"grepai_index_status",
	// Disabled until grepai exposes RPG through the installed CLI.
	// "grepai_rpg_search",
	// "grepai_rpg_fetch",
	// "grepai_rpg_explore",
] as const;
...
type TraceParams = { symbol: string; workspace?: string; project?: string; format?: GrepaiFormat };
...
type StatusParams = Record<string, never>;
...
const TOOL_SPECS = [
	...
	// },
	{
		...
		buildArgs: (_params: StatusParams) => ["status", "--no-ui"],
	},
	// Disabled until grepai exposes RPG through the installed CLI.
	// {
